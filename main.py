...
def manually_fill():
    ...
    def fill_attendance():
        ...
        try:
            ...
            connection = pymysql.connect(
                host='localhost', user='root', password='123', db='manually_fill_attendance')
        ...
        try:
            cursor.execute(pymysql)  # for create a table
        ...
        if subb == '':
            ...
            def err_screen1():
                ...
                errsc2.configure(background='lightblue')
            ...
            def create_csv():
                ...
                csv_name = 'C:/Users/mukin/PycharmProjects/Face-Recognition-Attendance-System/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"C:/Users/mukin/PycharmProjects/Face-Recognition-Attendance-System\Attendance\Manually Attendance\-------Check atttendance-------"')
    ...
    SUB = tk.Label( text="Enter Subject : ", width=15, height=2,
                   fg="black", bg="grey80", font=('times', 15, ' bold '))
    SUB.place(x=30, y=100)

    global SUB_ENTRY

    SUB_ENTRY = tk.Entry( width=20, bg="white",
                         fg="black", font=('times', 23))
    SUB_ENTRY.place(x=250, y=105)

    fill_manual_attendance = tk.Button( text="Fill Attendance", command=fill_attendance, fg="black", bg="SkyBlue1", width=20, height=2,
                                       activebackground="white", font=('times', 15, ' bold '))
...
def err_screen():
    ...
    sc1.title('Warning!!')
    sc1.configure(background='lightblue')
...
def err_screen1():
    ...
    sc2.title('Warning!!')
    sc2.configure(background='lightblue')
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='lightblue')
                cs = 'C:/Users/mukin/PycharmProjects/Face-Recognition-Attendance-System/' + fileName
    ...
    windo.configure(background='lightblue')
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"C:/Users/mukin/PycharmProjects/Face-Recognition-Attendance-System\Attendance\-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == 'mukesh':
            if password == 'mukesh123':
                ...
                cs = 'C:/Users/mukin/PycharmProjects/Face-Recognition-Attendance-System/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
...
#quitWindow = tk.Button(window, text="Manually Fill Attendance", command=manually_fill, fg="black",tkinterbg="SkyBlue1", width=20, height=3, activebackground="white", font=('times', 15, ' bold '))
